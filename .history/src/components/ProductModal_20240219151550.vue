                ...
                <v-card-text>
                        ...
                        <div class="row orderTitle">
                            <div class="container">
                                    ...
                                    >
                                    <div class="col-12">    
                                        <table class="table mb-250 d-flex justify-center">
                                            <tr class="ingredientsTable unselectable">
                                                ...
                                                <td class="toppimgTitle ingredientsTable">
                                                <div class="toppingName">
                                                    {{ ingredient.name }}
                                                    <div class="toppingSettInner">
                                                ...
                                                <td>
                                                    <div class="qty unselectable ingredientsTable" v-if="ingredient.id == 24" @click="clickIncrement(ingredient)">
