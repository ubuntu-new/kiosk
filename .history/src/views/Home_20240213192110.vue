<template style="background-color: #F5E1AB;">
  ...
  <div class="container-fluid h-100">
    <div class="d-flex d-flex align-center mb-6 v-card v-card--flat v-sheet theme--light rounded-0 grey lighten-2 h-100">
  ...
  <div class="container position-relative" style="top: -20px;">
    <v-row justify="center">
      <v-col cols="auto" @click="sortCat(3)">
       
        <div class="position-relative">                 
                  <img src="../assets/img/logo.png" alt="tab1" class="mb-5 logo" style="top: 20px;
    position: relative;
    margin-right: 50px;">                 
              </div>
      ...
      <v-col cols="auto"  @click="sortCat(1)">
        <v-btn
          :ripple="false"
          height="100"
          min-width="164"
      ...
      <v-col cols="auto"  @click="sortCat(2)">
        <v-btn
          :ripple="false"
          height="100"
          min-width="164"
      ...
      <v-col cols="auto" @click="sortCat(0)">
        <v-btn
          :ripple="false"
          height="100"
          min-width="164"
      ...
      <v-col cols="auto"  @click="toogleCart()" v-if="cartLength != 0">
        <v-btn
          :ripple="false"
          height="100"
          min-width="164"
    ...
    <v-btn @click="toogleCart()" v-if="cartLength != 0"
      :ripple="false"
      height="100"
      min-width="164"
      class="kalata green"
    ...
    <!-- <div class="kalata" @click="toogleCart()" v-if="cartLength != 0">
      Cart
    </div> -->
    ...
    <Checkout :activeCheckout="openCheckout" @close-dialog="closeCheckoutDialog" />
</template>
