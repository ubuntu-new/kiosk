<template style="background-color: #F5E1AB;">
  ...
  <div class="container position-relative" style="top: -20px;">
    <v-row justify="center">
      ...
      <v-col cols="auto"  @click="toogleCart()">
        <v-btn
          :ripple="false"
          height="72"
          min-width="164"
    ...
    <!-- <div class="row  h-100">
      ...
      <div class="col"  @click="sortCat(3)">
        <button type="button" class="v-btn v-btn--elevated v-theme--light v-btn--density-default v-btn--size-x-large v-btn--variant-elevated">
