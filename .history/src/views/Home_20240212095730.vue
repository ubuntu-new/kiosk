<template style="background-color: #F5E1AB;">
  ...
  <div class="container position-relative" style="top: -20px;">
    <div class="row d-flex align-items-center justify-content-center h-100">
      ...
      <div class="col">
        <button type="button" class="v-btn v-btn--elevated v-theme--light v-btn--density-default v-btn--size-x-large v-btn--variant-elevated"><span class="v-btn__overlay"></span><span class="v-btn__underlay"></span><!----><span class="v-btn__content" data-no-activator="">X-Large Button</span><!----><!----></button>
      </div>
